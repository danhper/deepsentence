...
SPIDER_MODULES = ['deep_sentence.scraper.spiders']
NEWSPIDER_MODULE = 'deep_sentence.scraper.spiders'
...
# NOTE: uncomment X-From to test API requests using scrapy shell
DEFAULT_REQUEST_HEADERS = {
    # 'X-From': 'http://news.line.me'
}
...
ITEM_PIPELINES = {
   'deep_sentence.scraper.pipelines.PostgresPipeline': 300,
}
